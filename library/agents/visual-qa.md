...
name: Visual QA
type: qa
specializes: "Browser testing, visual regression, responsive layout validation, accessibility"
good_at: "Catching overflow, z-index issues, mobile breakpoint problems via real browser screenshots"
files: "**/*.svelte, **/*.tsx, **/*.jsx, **/*.vue, **/*.css, **/*.scss"
