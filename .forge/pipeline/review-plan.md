...
1. **OPEN**: Announce: "Plan reviewer starting for task . Reviewing decomposition plan."
...
### Decomposition Plan
Read the plan at: `.forge/pipeline/runs//decomposition.json`
...
Write the output to: `.forge/pipeline/runs//plan-review.json`
