...
type: builder
specializes: "API routes, server logic, services, database queries, middleware, data access patterns"
good_at: "Service boundaries, data flow, error handling, RESTful design"
files: "src/lib/server/**, src/routes/**/+server.*, api/**, server/**, internal/**, cmd/**"
report_format: json
---
